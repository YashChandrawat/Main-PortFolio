    ...
    <section className="section">
      <div className="leftPart">
        ...
        <h1 className="home-heading">
          <span className="fade-in-text">{name}</span>
        </h1>
        <h3 className="fade-in-text heading-three">MERN STACK WEB DEVELOPER</h3>
        <div className="fade-in-text">
          ...
          <button className="btn btn-hover">
            <a
              href="https://drive.google.com/file/d/1uyqEg7sZUO8jIxSCh-_1qKROphBOYX39/view?usp=drive_link"
              target="blank"
            >
              GET CV
            </a>
